...
dataFile.SWOWZH           = './data/SWOW-ZH_R55.csv'
results.file.SWOWZH.R1    = './output/cueStats.SWOW-ZH.R1.csv'
results.file.SWOWZH.R123  = './output/cueStats.SWOW-ZH.R123.csv'
report.file               = './output/reports/cueStats.SWOW-ZH.rds'

# Load the removed vertices from the strongly connected components
components = readRDS('./output/reports/components.SWOW-ZH.rds')

## SWOW-R1 statistics
X.R1              = importDataSWOW(dataFile.SWOWZH,'R1')
...
H.R1              = getEntropy(X.R1,'cues') # NOTICE RAM
...
H.R123           = getEntropy(X.R123,'cues') # NOTICE RAM
