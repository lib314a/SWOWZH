# The SWOW-ZH R pipeline was adapted from SWOW-EN R pipeline
...
# It's based on an analysis of contingency tables for each cue in a dataset of over 9,000 cues
...
outputFile      = './output/responseR12ChainingSWOW-ZN.csv'
