...
The preprocessing scripts consist of `networkGeneration.m`, `frequencyCalculating.m`, `centralityCalculating.m` and `similarityCalculating.m` scripts.
